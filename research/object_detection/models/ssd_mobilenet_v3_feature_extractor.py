...
class SSDMobileNetV3FeatureExtractor(ssd_meta_arch.SSDFeatureExtractor):
  """SSD Feature Extractor using MobilenetV3 features."""
...
class SSDMobileNetV3FeatureExtractorFactory:
    def __init__(self, num_layers=6):
        self._num_layers = num_layers

    def __call__(self, *args, **kwargs):
        return SSDMobileNetV3FeatureExtractor(num_layers=self._num_layers, *args, **kwargs)
