...
class FasterRCNNResnet26FeatureExtractor(FasterRCNNResnetV1FeatureExtractor):
  """Faster R-CNN Resnet 26 feature extractor implementation."""
  ...
  def __init__(self,
    ...
    """
    super(FasterRCNNResnet26FeatureExtractor, self).__init__(
        'resnet_v1_26', resnet_v1.resnet_v1_26, is_training,
