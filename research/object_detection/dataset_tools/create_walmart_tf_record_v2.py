...
def main():
    ...
    write_records(train_examples, r'D:\temp\Walmart\Records\walmart_train_v2.record', num_shards=5)
    write_records(val_examples, r'D:\temp\Walmart\Records\walmart_val_v2.record', num_shards=2)
