...
def resnet_v1_50_5(inputs,
                 ...
                 store_non_strided_activations=False,
                 reuse=None,
                 scope='resnet_v1_50_5'):
  """ResNet-50_5 model of [1]. See resnet_v1() for arg and return description."""
  blocks = [
      resnet_v1_block('block1', base_depth=64, num_units=2, stride=2),  # 256
      resnet_v1_block('block2', base_depth=128, num_units=3, stride=2),  # 128
      resnet_v1_block('block3', base_depth=256, num_units=4, stride=2),  # 64
      resnet_v1_block('block3_1', base_depth=256, num_units=4, stride=2),  # 32
      resnet_v1_block('block4', base_depth=512, num_units=3, stride=2),  # 16
  ]
  return resnet_v1(inputs, blocks, num_classes, is_training,
                   global_pool=global_pool, output_stride=output_stride,
                   include_root_block=True, spatial_squeeze=spatial_squeeze,
                   store_non_strided_activations=store_non_strided_activations,
                   reuse=reuse, scope=scope)
resnet_v1_50_5.default_image_size = resnet_v1.default_image_size
