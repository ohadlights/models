...
# Wrappers for mobilenet v3 with depth-multipliers. Be noticed that
...
mobilenet_v3_140 = wrapped_partial(mobilenet, depth_multiplier=1.4)
mobilenet_v3_050 = wrapped_partial(mobilenet, depth_multiplier=0.50,
                                   finegrain_classification_mode=True)
mobilenet_v3_035 = wrapped_partial(mobilenet, depth_multiplier=0.35,
                                   finegrain_classification_mode=True)
...
def training_scope(**kwargs):
  """Defines MobilenetV3 training scope.
  ...
  Returns:
    An `arg_scope` to use for the mobilenet v3 model.
  """
