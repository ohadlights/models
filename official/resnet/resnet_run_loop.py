...
def resnet_model_fn(features, labels, mode, model_class, num_classes, dropout_rate,
  ...
  model = model_class(resnet_size, num_classes=num_classes, dropout_rate=dropout_rate, data_format=data_format,
  ...
  re_mic, pr_mic, f1_mic, re_mac, pr_mac, f1_mac = calc_f1_score(probabilities_32, labels_32)
